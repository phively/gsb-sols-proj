...
Note that this is fiscal, not calendar, year. FY2011 didn't have much stage progress, but it is the first year of data.
...
Looks like 2012 was a particularly good year, but it's normal to have lots of duds in those winter months
...
There are a couple of crossover points; January for Plan and Clear; Jan or Feb for ask (though it crosses back in March interestingly). Can't count on oral pledges made in May or June coming in before the end of the year. Let's focus on asks in the MG range, $x\in[\$100\textrm{k},\$5\textrm{M})$:
