...
For simplicity's sake, we can use the transformed `Expected.Amt` and corresponding `Stage.Future` for each of the models. Now, calculating predicted amounts for the held-out FY16 data:
...
# predict(lm.p, newdata=holdout)
# predict(lm.c, newdata=holdout)
# predict(lm.a, newdata=holdout)
# predict(lm.o, newdata=holdout)
```