...
Now that we have a satisfactory model, JMod and GLM can be compared side-by-side on historical point-in-time data.
...
GLM is clearly superior until the beginning of 2014; after that it's more of a toss-up. The dataset did not include any solicitations closing after 2/2/2016, so I compiled some more historical data and re-created this plot using all available FY16 data.
