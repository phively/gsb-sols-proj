...
jmod <- na.omit(JMod.err(probs=jmod.1$prob, truth=mdat$FY.Plan.Book))
...
jmod <- na.omit(JMod.err(probs=jmod.2$prob, truth=mdat$FY.Clear.Book))
...
jmod <- na.omit(JMod.err(probs=jmod.3$prob, truth=mdat$FY.Ask.Book))
...
jmod <- na.omit(JMod.err(probs=jmod.4$prob, truth=mdat$FY.Oral.Book))
...
# GLM for plan stage
confusion.wtd(preds=fitted(glm.pln.1), truth=model.frame(glm.pln.1)[,1], dimnames=c("truth","pred"))
# JMod for plan stage
confusion.wtd(preds=jmod.1$prob, truth=mdat$FY.Plan.Book, dimnames=c("truth","pred"))
```
...
```{r, message=F, warning=F, cache=F}
# GLM for clear stage
confusion.wtd(preds=fitted(glm.clr.1), truth=model.frame(glm.clr.1)[,1], dimnames=c("truth","pred"))
# JMod for clear stage
confusion.wtd(preds=na.omit(jmod.2$prob), truth=na.omit(mdat$FY.Clear.Book), dimnames=c("truth","pred"))
```
...
```{r, message=F, warning=F, cache=F}
# GLM for ask stage
confusion.wtd(preds=fitted(glm.ask.1), truth=model.frame(glm.ask.1)[,1], dimnames=c("truth","pred"))
# JMod for ask stage
confusion.wtd(preds=na.omit(jmod.3$prob), truth=na.omit(mdat$FY.Ask.Book), dimnames=c("truth","pred"))
```
...
```{r, message=F, warning=F, cache=F}
# GLM for oral stage
confusion.wtd(preds=fitted(glm.ora.1), truth=model.frame(glm.ora.1)[,1], dimnames=c("truth","pred"))
# JMod for oral stage
confusion.wtd(preds=na.omit(jmod.4$prob), truth=na.omit(mdat$FY.Oral.Book), dimnames=c("truth","pred"))
```
